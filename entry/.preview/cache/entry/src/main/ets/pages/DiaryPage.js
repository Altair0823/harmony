...
class DiaryPage extends ViewPU {
    ...
    itemHead(text, parent = null) {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.create(text);
            Text.debugLine("pages/DiaryPage.ets(31:5)");
            Text.fontSize(20);
    ...
    itemFoot(num, parent = null) {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create('1');
            Text.debugLine("pages/DiaryPage.ets(40:5)");
            Text.fontSize(16);
            Text.backgroundColor(0xAABBCC);
            Text.width("100%");
            Text.padding(5);
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Row.create();
            Row.debugLine("pages/DiaryPage.ets(48:5)");
            if (!isInitialRender) {
                Row.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Column.create();
            Column.debugLine("pages/DiaryPage.ets(49:7)");
            Column.height('100%');
            if (!isInitialRender) {
                Column.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            TextInput.debugLine("pages/DiaryPage.ets(52:9)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            TextArea.debugLine("pages/DiaryPage.ets(62:9)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Button.debugLine("pages/DiaryPage.ets(69:9)");
            Button.width('90%');
            Button.margin(20);
            Button.onClick(() => {
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Button.createWithLabel('新建', { type: ButtonType.Capsule, stateEffect: true });
            Button.debugLine("pages/DiaryPage.ets(87:9)");
            Button.width('90%');
            Button.margin(20);
            Button.onClick(() => {
                let diaryD = {
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            List.debugLine("pages/DiaryPage.ets(111:9)");
            List.width('70%');
            List.height('70%');
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            const forEachItemGenFunction = _item => {
                ...
                this.observeComponentCreation((elmtId, isInitialRender) => {
                    ...
                    ListItemGroup.debugLine("pages/DiaryPage.ets(113:13)");
                ...
                });
                {
                    ...
                    const itemCreation = (elmtId, isInitialRender) => {
                        ...
                        ListItem.debugLine("pages/DiaryPage.ets(114:15)");
                        if (!isInitialRender) {
                            ListItem.pop();
                        }
                        ViewStackProcessor.StopGetAccessRecording();
                    ...
                    const observedDeepRender = () => {
                        ...
                        this.observeComponentCreation((elmtId, isInitialRender) => {
                            ...
                            Text.debugLine("pages/DiaryPage.ets(115:17)");
                            Text.width("100%");
                            Text.height(25);
                            Text.fontSize(20);
                            Text.textAlign(TextAlign.Center);
